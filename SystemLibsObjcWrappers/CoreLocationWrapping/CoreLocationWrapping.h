...
- (void)locationManager:(CLWLocationManager *)manager
     didUpdateLocations:(NSArray<CLWLocation *> *)locations __OSX_AVAILABLE_STARTING(__MAC_10_9,__IPHONE_6_0);
...
- (void)locationManager:(CLWLocationManager *)manager didChangeAuthorizationStatus:(CLWAuthorizationStatus)status __OSX_AVAILABLE_STARTING(__MAC_10_7,__IPHONE_4_2);
...
- (void)locationManager:(CLWLocationManager *)manager
       didUpdateHeading:(CLWHeading *)newHeading __OSX_AVAILABLE_STARTING(__MAC_NA,__IPHONE_3_0) __TVOS_PROHIBITED __WATCHOS_PROHIBITED;
